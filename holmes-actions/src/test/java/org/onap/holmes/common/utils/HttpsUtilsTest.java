...
@PrepareForTest({HttpsUtils.class, HttpClient.class})
...
public class HttpsUtilsTest {
    ...
    public void testHttpsUtil_get_excepiton() throws Exception {
        ...
        thrown.expectMessage("Failed to use get method get data from server");
        String url = "host";
    ...
    public void testHttpsUtil_post_excepiton() throws Exception {
        thrown.expect(CorrelationException.class);
        thrown.expectMessage("Failed to use post method to get data from server");
        String url = "host";
        Map<String, String> header = new HashMap<>();
        header.put("accept", "application/json");
        Map<String, String> para = new HashMap<>();
