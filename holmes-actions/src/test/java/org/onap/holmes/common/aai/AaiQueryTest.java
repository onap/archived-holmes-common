...
public class AaiQueryTest {
    ...
    public void testAaiQuery_getVmResourceLinks_ok() throws Exception {
        ...
        assertTrue(resource.equals("le-vserver-id-val-51834"));
        PowerMock.verifyAll();
    }
    ...
    public void testAaiQuery_getHeaders() throws Exception {
        ...
        assertTrue(actual.get("X-TransactionId").equals("9999"));
        assertTrue(actual.get("X-FromAppId").equals("jimmy-postman"));
        assertTrue(actual.get("Authorization").equals("Basic QUFJOkFBSQ=="));
        assertTrue(actual.get("Accept").equals("application/json"));
        PowerMock.verifyAll();
    }
}
